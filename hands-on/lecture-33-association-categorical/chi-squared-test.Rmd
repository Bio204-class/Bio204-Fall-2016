...
```{r}
addmargins(xtabs(~ sex + survived, titanic))
```
...
```{r}
observed.counts <- xtabs(~ sex + survived, titanic)
...
For the Titanic example, $m = 2$ and $n = 2$, therefore the degrees of freedom, $df = 1$.  The $\chi^2_{1}$ distribution looks like this:
