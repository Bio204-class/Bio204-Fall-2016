...
## Problem 1.2: Univariate distributions

Generate histograms for each of the variables in `trees`.
...
## Problem 1.3: Measures of association
...
Using the `plot3D` package, generate a 3D regression plot for Volume as a function of Girth and Height.
